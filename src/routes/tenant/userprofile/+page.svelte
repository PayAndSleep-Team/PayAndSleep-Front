...
<div class="w-full min-h-full relative">
  <div class="w-full h-full flex flex-col items-center justify-center">
    <div class="w-full pt-16 flex flex-col items-center px-10">
      ...
      {#if isEditing}
        <input
          class="mb-4 py-1 px-6 rounded-xl border-2 border-[#404040] bg-[#F2F2F2] text-left placeholder-[#8B8B8C] font-jeju text-xl font-normal"
          bind:value={tempName}
      ...
      {#if isEditing}
        <input
          class="py-1 px-6 rounded-xl border-2 border-[#404040] bg-[#F2F2F2] text-left placeholder-[#8B8B8C] font-jeju text-xl font-normal"
      ...
      <div class="w-full max-w-2xl text-left mb-10 relative mr-24">
        ...
        {#if isEditing}
          <input
            class="mb-4 w-full py-1 px-6 rounded-xl border-[#404040] bg-[#F2F2F2] text-left placeholder-[#8B8B8C] font-jeju text-xl font-normal"
        ...
        {/if}
        <div class="absolute bottom-0 left-0 w-full border-t-2"></div>
      </div>
        ...
        <div class="grid grid-cols-2 gap-6">
          {#each history as item}
            <div class="bg-white rounded-xl shadow overflow-hidden p-2">
              <div class="flex">
                <div>
                  <img src="/images/grayRect.svg" alt="" class="h-20" />
                </div>
                <div class="flex flex-col justify-center">
                  <div class="px-3 text-xl text-[#404040]">
