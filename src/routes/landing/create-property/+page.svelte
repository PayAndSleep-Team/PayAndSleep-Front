...
<div class="w-full h-screen flex flex-col items-center justify-center">
    <!-- create property -->
    <div
        class="bg-[rgba(242,242,242,0.8)] rounded-2xl w-[45%] h-[95%] shadow-lg flex flex-col items-center justify-center min-w-[420px]"
    >
        <h1
        ...
        <form class="w-[90%] max-w-[550px] min-w-[400px] mt-4">
            ...
            <div class="relative mb-4">
                <select
                    ...
                    class="w-full py-2.5 px-6 rounded-[25px] border-2 border-[#404040] bg-transparent text-left placeholder-[#8B8B8C] font-jeju text-xl font-normal {bank_name
                        ? 'text-[#404040]'
                        : 'text-[#8B8B8C]'} appearance-none"
                >
