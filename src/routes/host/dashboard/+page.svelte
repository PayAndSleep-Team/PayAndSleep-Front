...
<div class="w-full min-h-screen flex items-center justify-center p-4">
    <div class="w-full">
            ...
            <div class="bg-white rounded-xl shadow overflow-hidden p-4">
                <div class="flex">
                  ...
                  <div class="flex flex-col">
                    <div class="px-3 text-xl text-[#D0854C]">ห้องที่ว่าง</div>
                    <div
              ...
              <div class="bg-white rounded-xl shadow overflow-hidden p-4">
                <div class="flex">
                  ...
                  <div class="flex flex-col">
                    <div class="px-3 text-xl text-[#546882]">ห้องที่ว่าง</div>
                    <div
        ...
        <div class="grid grid-cols-3 gap-6 mb-6">
            <div class="bg-white p-6 rounded-lg shadow-md relative flex justify-center items-center">
                    ...
                    {#each currentTenants as tenant}
                        <div class="flex justify-between items-center p-3 border-b">
                            <div class="flex"><p class="text-lg font-bold">{tenant.room}</p>
                                <p class="text-lg pl-2"> - {tenant.name}</p></div>
        ...
        <div class="grid grid-cols-2 gap-6">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h3 class="text-xl font-bold mb-4 text-[#557B55]">ยอดรายการที่ยังไม่ชำระ</h3>
                <div class="h-64 overflow-y-auto">
                    {#each paidBalances as balance}
                        <div class="flex justify-between p-3 border-b text-[#557B55]">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h3 class="text-xl font-bold mb-4 text-[#D04C4C]">ยอดรายการที่ยังไม่ชำระ</h3>
                <div class="h-64 overflow-y-auto">
                    {#each unpaidBalances as balance}
                        <div class="flex justify-between p-3 border-b text-[#D04C4C]">
                            <p class="font-bold">{balance.room}</p>
                            <p>{balance.amount} บาท</p>
                            <p>{balance.dueDate}</p>
                        </div>
