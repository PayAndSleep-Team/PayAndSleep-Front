<script>
    ...
    $: totalWater = water * waterPerUnit;
    $: totalElectricity = electricity * electricityPerUnit;
    $: total = rent + totalWater + totalElectricity + lateFee;
</script>
          ...
          <div class="flex items-center h-full">
            ...
            <div class="flex flex-col py-2">
              ...
              <div class="flex items-center px-3">
                ...
                <span class="text-2xl sm:text-4xl font-bold text-[#557B55]">/ 67</span>
              </div>
            </div>
          </div>
        </div>
